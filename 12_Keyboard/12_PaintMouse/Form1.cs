namespace PaintMouse
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e) // w, a, s ja d -n‰pp‰imet tikku-ukon liikuttamiseen
        {
            // tarkistukset mit‰ n‰pp‰int‰ on painettu (nopeus-muuttuja apuna koordinaateissa liikkumiseen)
            if (e.KeyCode == Keys.W)
            {                
                piste.Y -= nopeus;               
            }
